    ...
    )
{
    ...
    do {
       ...
       //PR388219,398706-Hualan su update MTK patch for PR377531 Add begin
	//porting P257_JRD377531_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P257_.tar.gz Delete begin
        // ADD HT Capability
        //u4RetValue += (ELEM_HDR_LEN + ELEM_MAX_LEN_HT_CAP);
	//porting P257_JRD377531_For_JRDSH77_CU_JB_ALPS.JB.MP.V1_P257_.tar.gz Delete end
        // ADD WMM Information Element
        u4RetValue += (ELEM_HDR_LEN + ELEM_MAX_LEN_WMM_INFO);
       //PR388219,398706-Hualan su update MTK patch for PR377531 Add end
